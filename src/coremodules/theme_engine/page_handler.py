...
class BasicPageHandler(TemplateBasedPageHandler):
 ...
 def compile_stylesheets(self, page):
  ...
  if 'stylesheets' in self.theme_config:
   s += list(str(Stylesheet(
    '/theme/' + self.module_config['active_theme'] + '/' + self.theme_config['stylesheet_directory'] + '/' + a)) for a
 ...
 def compile_scripts(self, page):
  ...
  if 'scripts' in self.theme_config:
   s += list(
    str(Script(self.module_config['active_theme_path'] + '/' + self.theme_config['script_directory'] + '/' + a)) for a
