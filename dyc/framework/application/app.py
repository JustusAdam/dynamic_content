...
from dyc.util import console, lazy, catch_vardump, structures
from dyc import http, middleware
...
class Application(threading.Thread, lazy.Loadable):
    ...
    def __init__(self, init_function=None):
        ...
        self.decorator = dyc.get_component('TemplateFormatter')
    ...
    @catch_vardump
    @dyc.inject_method(pathmap='PathMap')
